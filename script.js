...
if (backButton && appContainer && routeFoundBtn && directionsRenderer && map) {
    backButton.addEventListener('click', () => {
     ...
     if (!directionsRenderer) console.error("Setup Listener Voltar: directionsRenderer não encontrado.");
     if (!map) console.error("Setup Listener Voltar: map não encontrado.");
}
// *******************************************************************
